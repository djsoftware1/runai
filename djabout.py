...
class djAbout:
    ...
    def show_about(self):
        ...
        print(f"{Fore.YELLOW}runai {Fore.CYAN}Run or automate AI/LLM & other kinds of tasks, like code refactoring, supporting AutoGen.{Style.RESET_ALL}")
        ...
        print(f"{Fore.YELLOW}Created by{Fore.GREEN} David Joffe. v{djversion.Version().get_version()} beta. {Fore.BLUE}github.com/djsoftware1/runai{Fore.BLUE} djoffe.com/dj-software/runai")
        print(f"{Style.RESET_ALL}__________________________________________________________________")
        print(f"{Fore.GREEN}Note for some tasks this tool may modify files. Use with caution. It is suggested to")
        print(f"{Fore.GREEN}always backup your data first, work in a 'sandbox' copy, and check any changes.{Style.RESET_ALL}")
